...
std::vector<std::vector<uint8_t>> fail_wasms = {
   ...
   make_wasm({0xfd, 12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}), // v128.const
   make_wasm({0x41, 0x00, 0x41, 0x00, 0x41, 0x00, 0xfc, 10, 0x00, 0x00}), // memory.copy
