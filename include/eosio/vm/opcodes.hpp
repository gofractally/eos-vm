...
namespace eosio { namespace vm {
   enum opcodes {
      ...
      EOS_VM_REF_OPS(EOS_VM_CREATE_ENUM)
   ...
   enum ext_opcodes {
       EOS_VM_DATA_OPS(EOS_VM_CREATE_ENUM)
       EOS_VM_EXT_OPS(EOS_VM_CREATE_ENUM)
   };
   ...
   struct opcode_utils {
      std::map<uint16_t, std::string> opcode_map{
         ...
         EOS_VM_REF_OPS(EOS_VM_CREATE_MAP)
   ...
   EOS_VM_DATA_OPS(EOS_VM_CREATE_DATA_TYPES)
   EOS_VM_EXT_OPS(EOS_VM_CREATE_TYPES)
   ...
   using opcode = variant<
      ...
      EOS_VM_DATA_OPS(EOS_VM_IDENTITY)
      EOS_VM_EXT_OPS(EOS_VM_IDENTITY)
